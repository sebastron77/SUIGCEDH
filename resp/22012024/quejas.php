...
$sql = "SELECT q.folio_queja,q.id_queja_date, mp.descripcion as medio_presentacion, au.nombre_autoridad as autoridad_responsable, cq.nombre as nombre_quejoso, cq.paterno a_paterno_quejoso,
			...
			u.username, a.nombre_area, q.fecha_vencimiento
            FROM quejas_dates q
...
if ( ($nivel == 5) || ($nivel == 19) || ($nivel == 50)) :		
$sql .= " AND q.id_area_asignada = '".$area_user['id_area']."' AND du.id_det_usuario = '".$area_user['id_det_usuario']."'";
endif;
$sql .= " AND q.folio_queja LIKE '%/".$ejercicio."-%'  ORDER BY q.id_queja_date DESC";
