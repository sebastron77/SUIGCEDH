...
if (($nivel_user <= 2) || ($nivel_user == 5) || ($nivel_user == 7) || ($nivel_user == 50) || ($nivel_user == 53)) {
...
<script type="text/javascript">	
 function changueAnio(anio){
	 //alert(anio);
	 window.open("actuaciones.php?anio="+anio,"_self");
	...
	<div class="row">
	    <div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading clearfix">
					<div class="col-md-10">
							<strong>
								...
								<span>Lista de Actuaciones <?php echo $ejercicio ?></span>
							</strong>
					</div>
					<div class="col-md-2">
                ...
                <a href="add_actuacion.php" style="margin-left: 10px;margin-right: 10px" class="btn btn-info pull-right">Agregar actuación</a>
                <?php endif; ?>										
